...
def convert_stereo():
    dir2nori('s3://lzh-share/stereo_blur_data/train/blur_crops',
             ...
             's3://llcv-dataspace/stereo_blur_data/train_v4.nori',
             './datasets/stereo_blur_data/train_v4.nori.json')
    ...
    dir2nori('s3://lzh-share/stereo_blur_data/test/input',
             ...
             's3://llcv-dataspace/stereo_blur_data/test_v4.nori',
             './datasets/stereo_blur_data/test_v4.nori.json')
